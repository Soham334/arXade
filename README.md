...
Demo
Watch the demo video here: arXade demo

Dataset
This project uses the arXiv CS Embeddings (Gemini-004-int8) dataset: https://www.kaggle.com/datasets/yxpx237/arxiv-cs-embeddings-gemini-004-int8
